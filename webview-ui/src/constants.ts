...
export const DANCE_FRAME_DURATION_SEC = 0.1;
...
export const DANCE_SWAY_AMPLITUDE_PX = 2;
export const DANCE_BOUNCE_AMPLITUDE_PX = 2;
export const DANCE_SWAY_FREQUENCY_HZ = 2.5;
export const DANCE_BOUNCE_FREQUENCY_HZ = 5;
